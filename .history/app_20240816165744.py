...
def predict():
    ...
    if form.validate_on_submit():
        ...
        if prediction == '1':
            cat = 'Non-critical'
            message = f"The restaurant falls into {cat:,.0f} category. You can your food there."
        else :
            cat = 'Critical'
            message = f"The restaurant falls into {cat:,.0f} category. It is advised to avoid that restaurant."
