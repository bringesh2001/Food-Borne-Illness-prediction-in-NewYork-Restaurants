...
def predict():
    ...
    if form.validate_on_submit():
        ...
        cat = np.where(prediction == 0, 'Not Critical Violation', 'Critical Violation')
        message = f"The restaurant falls into {cat} category. {'You can eat your food there.' if cat == 'Not Critical Violation' else 'It is advised to avoid that restaurant.'}"
